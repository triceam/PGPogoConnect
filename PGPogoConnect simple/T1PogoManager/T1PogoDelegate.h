...
// the locator view is a way for users to find a lost stylus.  there's no need to implement these unless you have a special use case
- ( BOOL ) pogoManager:( T1PogoManager * )manager shouldCloseLocatorView:( UIView * )locatorView;      // removed from superview unless NO
- ( void ) pogoManager:( T1PogoManager * )manager didCloseLocatorView:( UIView * )locatorView; // locator view removed from superview
