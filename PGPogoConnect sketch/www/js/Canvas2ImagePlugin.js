...
(function(cordova) {
	...
	Canvas2ImagePlugin.prototype.saveImageToLibrary = function(successCallback, failureCallback, canvasId) {
    ...
    Canvas2ImagePlugin.prototype.saveImageDataToLibrary = function(successCallback, failureCallback, imageData) {
        // successCallback required
        if (typeof successCallback != "function") {
            console.log("Canvas2ImagePlugin Error: successCallback is not a function");
            return;
